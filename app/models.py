...
class Library(Base):
    ...
    plex_sync_interval_hours: Mapped[float | None] = mapped_column(Float)
    sonarr_url: Mapped[str | None] = mapped_column(Text)
    sonarr_key: Mapped[str | None] = mapped_column(Text)
    radarr_url: Mapped[str | None] = mapped_column(Text)
    radarr_key: Mapped[str | None] = mapped_column(Text)
    overseerr_url: Mapped[str | None] = mapped_column(Text)
    overseerr_key: Mapped[str | None] = mapped_column(Text)
    ...
    qb_root_path: Mapped[str | None] = mapped_column(Text)
